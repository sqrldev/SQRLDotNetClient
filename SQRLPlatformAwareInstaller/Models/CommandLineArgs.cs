...
namespace SQRLPlatformAwareInstaller.Models
{
    ...
    /// by default it would be Install, but we also have the option to Uninstall and eventually upgrade the application.
    /// </summary>
    ...
    public class CommandLineArgs
    {
        ...
        /// <summary>
        /// Command line switch -z | zip "path" Specifies the location of the temporary update zip file (used in conjunction with update action)
        /// </summary>
